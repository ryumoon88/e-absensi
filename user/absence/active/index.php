...
$unfetched = getAllActiveAbsence($_SESSION['user_id']);
?>
...
<body class="d-flex">
    ...
    <div class="sidenav">
        <div class="sidenav-body">
            ...
            <div class="sidenav-links">
                ...
                <a href="./" class="btn mt-2 active text-white w-100 text-start"><i class="bi bi-activity me-3"></i>Active Absence</a>
    ...
    <div class="container p-5">
        <div class="input-group mb-3">
            ...
            <input type="search" class="form-control" name="q" placeholder="Search" aria-label="Search" aria-describedby="search" id="searchActiveAbsence">
        </div>
        <table class="table table-striped shrink text-center responsive-table">
            <thead class="table-dark">
                <tr>
                    <th>Absence Title</th>
                    <th class="shrink-md shrinkable">Absence Desc</th>
                    <th>Absence Status</th>
                    <th class="shrink-sm">Absence Owner</th>
            ...
            <tbody id="tbodyactive">
                ...
                <?php if (!$unfetched->num_rows) : ?>
                    <tr class="text-center">
                        <td colspan="6">There is no active absence for you today!</td>
                    <tr>
                    <?php else : ?>
