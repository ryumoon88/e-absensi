                    ...
                    if (result) {
                        ...
                        if (r.find("td").eq(hId).parents("table").first() != null) {
                            ...
                            if (r.parents("table").first().find("th").eq(hId).html().trim() === "") {
                                ...
                                r.next(".shrink-wrapper").find("td").append("<div class=\"shrinked-row\" style=\"display:none\"><div class=\"unshrink-" + result[1] + "\"><div class=\"text-start ps-3 fw-bold\">" + r.parents("table").first().find("th").eq(hId).html() + "</div><div class=\"text-end pe-3\">" + r.find("td").eq(hId).html() + "</div></div></div>");
                            };
